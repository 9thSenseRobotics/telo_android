...
// commandArguments (any arguments for the command specified: e.g. speed, angle,
// type, etc.; blank by default)
...
// mtr = new messageToRobot(driverAddr, driverName, robotAddr, responseValue [,
// commandArguments] [, comment]);

{
	...
	// 4-argument constructor: build this class from its component data without
	// a commandArgument or a comment
	{
	...
	// 5-argument constructor: build this class from its component data with a
	// command argument but without a comment
	{
		// set the class' properties from the passed-in values; if they're
		// unspecified, set as empty
		timeStamp = new MicroTime().smicrotime();

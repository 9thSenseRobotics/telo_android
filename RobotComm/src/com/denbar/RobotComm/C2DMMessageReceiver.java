...
/**
 * Receives messages from the cloud via push notifications (Google's C2DM)
 * 
...
public class C2DMMessageReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		// Toast.makeText(context, "Message Receiver called",
	...
	void broadcastIntent(Context context, String RobotCommand) {
		...
		// intentAmarino.putExtra(AmarinoIntent.EXTRA_DEVICE_ADDRESS,
		// "00:06:66:46:5A:91");
		String bluetoothAddress = C2DMApplication.getInstance()
				.getBluetoothAddress();
		intentAmarino.putExtra(AmarinoIntent.EXTRA_DEVICE_ADDRESS,
				bluetoothAddress);
		intentAmarino.putExtra(AmarinoIntent.EXTRA_DATA_TYPE,
				AmarinoIntent.INT_EXTRA);
		...
		// sendDataToServer(robotCommand); // echo the command back to the C2DM
		// server
